...
import com.mycompany.myapp.JhipsterUaaApp;
import com.mycompany.myapp.config.TestSecurityConfiguration;
import com.mycompany.myapp.service.JhipsterUaaKafkaProducer;
import com.mycompany.myapp.service.JhipsterUaaKafkaConsumer;
...
@SpringBootTest(classes = {JhipsterUaaApp.class, TestSecurityConfiguration.class})
@DirtiesContext(classMode = DirtiesContext.ClassMode.BEFORE_CLASS)
public class JhipsterUaaKafkaResourceIT {
    ...
    @Autowired
    private JhipsterUaaKafkaProducer producer;

    @Autowired
    private JhipsterUaaKafkaConsumer consumer;
    ...
    @BeforeEach
    public void setup() {
        JhipsterUaaKafkaResource kafkaResource = new JhipsterUaaKafkaResource(producer);
    ...
    public void producedMessageHasBeenConsumed() throws Exception {
        restMockMvc.perform(post("/api/jhipster-uaa-kafka/publish?message=test"))
